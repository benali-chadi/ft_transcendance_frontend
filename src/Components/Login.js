...
const Login = ({ user, setUser }) => {
	...
	return (
		...
		>
			{showSignUp && (
				<SignUp
					handleCancelClick={handleLoginClick}
					handleSaveClick={handleSaveClick}
				/>
			)}
			<div
				className="h-full min-h-max overflow-y-auto bg-50%w bg-no-repeat bg-top flex flex-col justify-end
