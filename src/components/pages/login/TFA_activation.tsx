        ...
        <Modal>
            <form onSubmit={async (e) => {
                ...
                try{
                    if (toDo === "enable")
                    {
                        let {data} = await axios.post(`${process.env.REACT_APP_BACKEND_URL}auth/validate-2Fa-token`,{
                            token: token
                        },{
                    ...
                    {
                        let {data} = await axios.post(`${process.env.REACT_APP_BACKEND_URL}auth/2fa/login`,{
                            token: token
                        },{
                            withCredentials:true
                        })
                    ...
                    {
                        let {data} = await axios.post(`${process.env.REACT_APP_BACKEND_URL}auth/disbale-2fa`,{
                            token: token
                        },{
                            withCredentials:true
                        })
